...
!(function (t, e) {
  ...
  var $ =
      window.requestAnimationFrame || Y('RequestAnimationFrame') || J,
    Q =
  ...
  (p.prototype = {
    ...
    (s.prototype = {
      ...
      contains: function (t) {
        t = ('number' == typeof t[0] || t instanceof v || 'lat' in t
          ? w
          : g)(t);
        var e,
          i,
        ...
        (function () {
          try {
            var t = document.createElement('div'),
              e =
                ((t.innerHTML = '<v:shape adj="1"/>'), t.firstChild);
            return (
  ...
  function ei(t, e) {
    if (e && t.length) {
      var i = (t = (function (t, e) {
        ...
        n = i.length,
        o = new (typeof Uint8Array != void 0 + ''
          ? Uint8Array
          : Array)(n);
      (o[0] = o[n - 1] = 1),
  ...
  function I(t) {
    return (
      !d(t[0]) || ('object' != typeof t[0][0] && void 0 !== t[0][0])
    );
  }
  function ai(t) {
    return (
        ...
        _adjustPan: function () {
          ...
          this.options.autoPan &&
            ...
            this._autopanning
              ...
              : ((t = this._map),
                (e =
                  parseInt(pe(this._container, 'marginBottom'), 10) ||
                  0),
  ...
  var _t = n.extend({
      ...
      _onMouseDown: function (t) {
        ...
        this._clearDeferredResetState(),
          ...
          re(),
          Le(),
          (this._startPoint = this._map.mouseEventToContainerPoint(
            t,
          )),
          S(
            document,
      ...
      n.extend({
        ...
        _onWheelScroll: function (t) {
          var e = He(t),
            ...
            e =
              ((this._delta += e),
              (this._lastMousePos = this._map.mouseEventToContainerPoint(
                t,
              )),
